 ...
 * @package WordPress
 */
define('WP_HOME','http://bkdstarlab.dx.am/');
define('WP_SITEURL','http://bkdstarlab.dx.am/');
// ** MySQL settings - You can get this info from your web host ** //
/** The name of the database for WordPress */
define('DB_NAME', '2674046_qa');

/** MySQL database username */
define('DB_USER', '2674046_qa');

/** MySQL database password */
define('DB_PASSWORD', 'B1nK3yM4nA');
